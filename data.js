...
const AGENTS = {
  1: [ // Thailand (visa-free)
    { id:"rocket", name:"Rocket Singh", icon:"\u26A1", promise:"Thailand is visa-free. TDAC for \u20B9500.", claim:"Cheapest. I fill the TDAC form. That's it.", gets:["TDAC form completed","Confirmation emailed","Immigration tips"], donts:["Slowest (7 days)","No travel guidance","No support if something goes wrong"], price:"\u20B9500", time:"7 days", play:"price", color:"#FEE2E2" },
    { id:"yoda", name:"Yoda", icon:"\u{1F9D9}", promise:"Thailand rules changed in 2026. I'll explain what you actually need.", claim:"I clarify the confusing stuff. You'll know exactly what to do at immigration.", gets:["I clarify: TDAC, VOA, or e-visa for YOUR trip","Document check before travel","WhatsApp for questions"], donts:["I don't do it for you \u2014 I guide you","No trip planning"], price:"\u20B91,500", time:"1 day", play:"guidance", color:"#E0F2FE" },
    { id:"sharma", name:"Sharma Ji", icon:"\u{1F468}\u200D\u{1F4BC}", promise:"Come to my office. I'll explain Thailand and do the TDAC.", claim:"20 years doing visas. Face-to-face. I sit with you and explain everything.", gets:["Face-to-face explanation","TDAC done + printed airport checklist","Call me anytime"], donts:["Need to visit office","No online tracking"], price:"\u20B91,500", time:"Same day", play:"relationship", color:"#F3F0EB" },
    ...
    { id:"gatsby", name:"Gatsby", icon:"\u{1F37E}", promise:"Thailand trip planned. TDAC + flights + hotels. Cancel anytime.", claim:"One payment. Flights, hotels, TDAC, insurance. Plans change? Full refund.", gets:["Refundable flights + hotels","TDAC + insurance handled","Cancel everything free"], donts:["Most expensive for a free visa"], price:"\u20B96,000", time:"2-3 days", play:"premium", color:"#FEF3C7" }
  ],
  2: [ // Dubai (standard e-visa)
    { id:"rocket", name:"Rocket Singh", icon:"\u26A1", promise:"Cheapest Dubai visa. All fees included.", claim:"Lowest price. I submit your application. Visa emailed. That's it.", gets:["Complete visa processing","All government fees included","Visa emailed","Track status online"], donts:["Not the fastest (3-5 days, not 24hr)","No WhatsApp support","No document help","No timing guarantee"], price:"\u20B97,000", time:"3-5 days", play:"price", color:"#FEE2E2" },
    { id:"yoda", name:"Yoda", icon:"\u{1F9D9}", promise:"First Dubai visa? I check everything so nothing goes wrong.", claim:"I verify photo, passport, form details. WhatsApp me any question.", gets:["Photo verified (size, background)","Passport scan quality checked","Form reviewed before submission","WhatsApp \u2014 ask me anything"], donts:["Not the cheapest","Not the fastest","No timing guarantee"], price:"\u20B98,500", time:"2 days", play:"guidance", color:"#E0F2FE" },
    { id:"sharma", name:"Sharma Ji", icon:"\u{1F468}\u200D\u{1F4BC}", promise:"WhatsApp me your passport photo. Pay when visa is ready.", claim:"Hundreds of Dubai visas done. WhatsApp me. Pay only when you get it.", gets:["Just WhatsApp \u2014 no app needed","I handle everything","Pay when visa is ready (not upfront)","Call me anytime"], donts:["Not the fastest (2-3 days)","No online tracking","No formal guarantee"], price:"\u20B98,000", time:"2-3 days", play:"relationship", color:"#F3F0EB" },
  ...
  3: [ // South Korea (sticker visa)
    { id:"rocket", name:"Rocket Singh", icon:"\u26A1", promise:"South Korea visa. Lowest price. I submit, you wait.", claim:"Basic service, honest price. Passport goes in, visa comes back.", gets:["Application prep + embassy submission","All fees included","Email when passport is ready"], donts:["No document guidance","No passport tracking (only status-change emails)","No cover letter help","No guarantee"], price:"\u20B95,000", time:"10 days", play:"price", color:"#FEE2E2" },
    { id:"yoda", name:"Yoda", icon:"\u{1F9D9}", promise:"Korean embassy is specific. Wrong photo size? Rejected. I know what they want.", claim:"I review every document before your passport goes in.", gets:["Embassy-specific checklist","I review every document before submission","WhatsApp support during the wait","I flag issues before submission"], donts:["I don't WRITE your cover letter","I don't handle passport logistics","No guarantee"], price:"\u20B97,000", time:"12 days", play:"guidance", color:"#E0F2FE" },
